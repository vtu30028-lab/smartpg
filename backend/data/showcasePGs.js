const showcasePGs = [
  {
    ...
    latitude: 12.9352, longitude: 77.6245, rent: 7500, rooms: 20, room_pricing: { double: 7500 },
  ...
  },
  {
    ...
    latitude: 12.9784, longitude: 77.6408, rent: 6500, rooms: 30, room_pricing: { triple: 6500 },
  ...
  },
  {
    ...
    latitude: 12.9116, longitude: 77.6473, rent: 5500, rooms: 15, room_pricing: { shared: 5500 },
  ...
  },
  {
    ...
    latitude: 12.9698, longitude: 77.7500, rent: 12000, rooms: 10, room_pricing: { single: 12000 },
  ...
  },
  {
    ...
    latitude: 12.9308, longitude: 77.5838, rent: 6000, rooms: 25, room_pricing: { double: 6000 },
  ...
  },
  {
    ...
    latitude: 12.9166, longitude: 77.6101, rent: 7200, rooms: 18, room_pricing: { double: 7200 },
    gender_preference: 'female', food_available: true, wifi: true, ac: true,
    attached_bathroom: true, laundry: true, parking: false,
  ...
  },
  {
    ...
    latitude: 12.9591, longitude: 77.6974, rent: 4500, rooms: 40, room_pricing: { shared: 4500 },
    gender_preference: 'any', food_available: false, wifi: true, ac: false,
  ...
  },
  {
    ...
    latitude: 12.9230, longitude: 77.5680, rent: 7800, rooms: 22, room_pricing: { triple: 7800 },
    gender_preference: 'any', food_available: true, wifi: true, ac: false,
    attached_bathroom: true, laundry: true, parking: false,
  ...
  },
  {
    ...
    latitude: 12.9250, longitude: 77.6762, rent: 9500, rooms: 16, room_pricing: { double: 9500 },
    gender_preference: 'any', food_available: true, wifi: true, ac: true,
    attached_bathroom: true, laundry: true, parking: true,
  ...
  },
  {
    ...
    latitude: 13.0104, longitude: 77.5514, rent: 6800, rooms: 14, room_pricing: { double: 6800 },
    gender_preference: 'any', food_available: true, wifi: true, ac: false,
    attached_bathroom: true, laundry: true, parking: false,
    images: ['https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=800'],
  ...
  },
  {
    ...
    latitude: 12.9080, longitude: 77.6510, rent: 4800, rooms: 30, room_pricing: { shared: 4800 },
    gender_preference: 'any', food_available: false, wifi: true, ac: false,
    attached_bathroom: false, laundry: false, parking: false,
    images: ['https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800'],
  ...
  },
  {
    ...
    latitude: 12.9719, longitude: 77.6412, rent: 11000, rooms: 8, room_pricing: { single: 11000 },
    gender_preference: 'any', food_available: true, wifi: true, ac: true,
    attached_bathroom: true, laundry: true, parking: true,
    images: ['https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800'],
...
function filterShowcasePGs(query) {
  ...
  if (roomType) results = results.filter((p) => p.room_pricing && p.room_pricing[roomType] !== undefined);
