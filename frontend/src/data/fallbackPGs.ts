...
export const fallbackPGs: PG[] = [
  {
    ...
    location: 'Koramangala, Bangalore', rent: 7500, rooms: 20, room_type: 'double',
  ...
  },
  {
    ...
    location: 'Whitefield, Bangalore', rent: 12000, rooms: 10, room_type: 'single',
  ...
  },
  {
    ...
    location: 'Jayanagar, Bangalore', rent: 7800, rooms: 22, room_type: 'triple',
  ...
  },
  {
    ...
    location: 'Bellandur, Bangalore', rent: 9500, rooms: 16, room_type: 'double',
    gender_preference: 'any', food_available: true, wifi: true, ac: true,
    attached_bathroom: true, laundry: true, parking: true,
